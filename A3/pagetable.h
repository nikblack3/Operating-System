...
#define PG_VALID        (0x1) // Valid bit in pgd or pte, set if in memory,		00001
#define PG_DIRTY        (0x2) // Dirty bit in pgd or pte, set if modified,		00010
#define PG_REF          (0x4) // Reference bit, set if page has been referenced,00100
#define PG_ONSWAP       (0x8) // Set if page has been evicted to swap,			01000
